...
FFMPEG_CFG_FLAGS_ARM="$FFMPEG_CFG_FLAGS_ARM --enable-asm"
...
FF_XCRUN_CC=`xcrun -sdk $FF_XCRUN_SDK -find clang`
...
FFMPEG_EXTRA_CFLAGS="-isysroot ${DEVELOPER}/Platforms/$FF_XCRUN_PLATFORM.platform/Developer/SDKs/$FF_XCRUN_PLATFORM${SDKVERSION}.sdk"
